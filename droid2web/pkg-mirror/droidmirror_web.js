/* @ts-self-types="./droidmirror_web.d.ts" */
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./droidmirror_web_bg.js": import0,
    };
}

const MirrorClientFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_mirrorclient_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('droidmirror_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
